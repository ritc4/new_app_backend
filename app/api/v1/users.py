...
from app.core.dependencies.user import get_current_customer, get_current_worker, get_user_service
...
async def complete_registration(
    data: CompleteRegistrationRequest, current_user: CurrentUserDep, service: UserServiceDep
):
...
async def read_current_user(current_user: CurrentUserDep, service: UserServiceDep):
...
async def update_username(data: UpdateUsernameRequest, current_user: CurrentUserDep, service: UserServiceDep):
...
async def update_email(data: UpdateEmailRequest, current_user: CurrentUserDep, service: UserServiceDep):
...
async def get_avatar_upload_link(current_user: CurrentUserDep, service: UserServiceDep, content_type: str = Query(...)):
...
async def list_sessions(current_user: CurrentUserDep, service: AuthServiceDep):
...
async def delete_account(current_user: CurrentUserDep, service: UserServiceDep):
